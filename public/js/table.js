...
export function replaceRow(id) {
    ...
    const oldRow =
        transactionsList.querySelector(
            `tr[data - id= "${id}"]`
        );
...
async function saveInlineEdit(row, id) {
    ...
    try {
        ...
        const data = {
            ...
            tipo:
                row.querySelector(".edit-type").value,

            origem:
                row.querySelector(".edit-origin").value,
...
function renderMobileCards(filtered) {
    ...
    < div class="card-header" >
            ...
            <button class="edit-mobile">
                Editar
            </button>

            <button class="delete-mobile">
                Excluir
            </button>

`;

        card.querySelector(".edit-mobile")
            .onclick = () =>
                editTransaction(t.id);

        card.querySelector(".delete-mobile")
            .onclick = () =>
